...
class Dynamics:
    ...
    def _get_thrust_from_cmd(self, command) -> th.Tensor:
        ...
        if self.action_type == ACTION_TYPE.THRUST:
            ...
            thrust_error = command[0] - (self._acceleration[2,:].clone().detach()+9.8) * self.m
            ...
            self._ctrl_i = (self._ctrl_i + (self._BODYRATE_PID.i @ (angular_velocity_error * self.dt))).clone().detach()
