...
class CustomMultiInputActorCriticPolicy(MultiInputActorCriticPolicy):
    features_extractor_alias = {
        ...
        # "StateIndexVdImageExtractor": StateIndexVdImageExtractor,
    ...
    def __init__(
        ...
        print("[CustomMultiInputActorCriticPolicy] __init__ start...", flush=True)
        ...
        print("[CustomMultiInputActorCriticPolicy] calling super().__init__ (create features_extractor)...", flush=True)
        super().__init__(
        ...
        print("[CustomMultiInputActorCriticPolicy] super().__init__ done, _build...", flush=True)
        ...
        print("[CustomMultiInputActorCriticPolicy] _build...", flush=True)
        self._build(lr_schedule)
        print("[CustomMultiInputActorCriticPolicy] __init__ done", flush=True)
